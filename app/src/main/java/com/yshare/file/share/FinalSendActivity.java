        ...
        public void onConnectionResult(String s, ConnectionResolution connectionResolution) {
            ...
            switch (connectionResolution.getStatus().getStatusCode()) {
                ...
                case ConnectionsStatusCodes.STATUS_CONNECTION_REJECTED:
                    ...
                    mainDiscoveryLayout.setVisibility(View.VISIBLE);
        ...
        public void onDisconnected(String s) {
            ...
            Nearby.getConnectionsClient(FinalSendActivity.this)
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getApplicationContext(), "Failed to generate reconnection request", Toast.LENGTH_SHORT).show();
                }
            });
                    ...
                    case 0:
                        ...
                        inflatedLayout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                mainDiscoveryLayout.setVisibility(View.GONE);
                                animation.setVisibility(View.GONE);
                                waitingText.setText("Generating Connection Request");
                                Nearby.getConnectionsClient(FinalSendActivity.this)
                                        .requestConnection(
                                    ...
                                    public void onSuccess(Void aVoid) {
                                       waitingLayout.setVisibility(View.VISIBLE);
                                        mainDiscoveryLayout.setVisibility(View.GONE);
                                        animation.setVisibility(View.GONE);
                                        waitingText.setText("Waiting For Response");
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        mainDiscoveryLayout.setVisibility(View.VISIBLE);
                                        animation.setVisibility(View.VISIBLE);
                                        Toast.makeText(getApplicationContext(), "Could not generate connection request", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
